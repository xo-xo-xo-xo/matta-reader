...
import MatugenIntegration from './matugen-integration';
...
export class Extension {
    ...
    static async start(): Promise<void> {
        ...
        // Initialize matugen integration (firefox only, guarded inside)
        MatugenIntegration.init((theme: Partial<Theme>) => {
            Extension.changeSettings({theme: {...UserStorage.settings.theme, ...theme}});
        });
    }
